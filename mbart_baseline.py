...
if "teo_UG" not in tokenizer.lang_code_to_id:
    ...
    tokenizer.id_to_lang_code[teo_id] = "teo_UG"   # Reverse mapping
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./lang_code_output_5epoch_dir",   # Change to "./lang_code_output_10epoch_dir" for epoch 10
